...
const styles = StyleSheet.create({
  ...
  heroCard: { minHeight: 170, borderRadius: 20, borderWidth: 1, borderColor: "#E5E2FF", backgroundColor: "#F8F7FF", paddingHorizontal: 22, paddingVertical: 28, overflow: "hidden", flexDirection: "row", justifyContent: "space-between" },
  heroTitle: { color: "#111111", fontSize: 24, fontWeight: "600" },
  heroCopy: { marginTop: 10, color: "#44527E", fontSize: 16, lineHeight: 24 },
  heroShape: { width: 140, alignItems: "center", justifyContent: "center" },
  heroCircle: { width: 68, height: 68, borderRadius: 34, borderWidth: 2, borderColor: "#6C62FF", position: "absolute", top: 12, left: 20 },
  heroSquare: { width: 68, height: 68, borderRadius: 14, borderWidth: 2, borderColor: "#6C62FF", position: "absolute", top: 44, left: 52 },
  sectionTitle: { marginTop: 24, marginBottom: 12, color: "#111111", fontSize: 20, fontWeight: "700" },
  benefitCard: { borderRadius: 18, borderWidth: 1, borderColor: "#E2E5EB", backgroundColor: "#FFFFFF", overflow: "hidden" },
  benefitItem: { minHeight: 86, paddingHorizontal: 16, paddingVertical: 14, flexDirection: "row", alignItems: "center" },
  benefitItemBorder: { borderBottomWidth: 1, borderBottomColor: "#ECEEF2" },
  benefitIcon: { width: 46, height: 46, borderRadius: 14, borderWidth: 1, borderColor: "#DDE2EC", alignItems: "center", justifyContent: "center" },
  benefitCopy: { flex: 1, marginLeft: 14 },
  benefitTitle: { color: "#111111", fontSize: 17, fontWeight: "700" },
  benefitSubtitle: { marginTop: 6, color: "#44527E", fontSize: 14, lineHeight: 20 },
  priceCard: { marginTop: 22, borderRadius: 18, borderWidth: 1, borderColor: "#E2E5EB", backgroundColor: "#FFFFFF", padding: 18 },
  priceHead: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  priceTitle: { color: "#111111", fontSize: 20, fontWeight: "700" },
  expire: { color: "#6A7290", fontSize: 15 },
  priceRow: { marginTop: 14, flexDirection: "row", alignItems: "baseline" },
  price: { color: "#6E63FF", fontSize: 46, fontWeight: "700" },
  priceUnit: { color: "#3E4761", fontSize: 15 },
  noteBox: { marginTop: 10, backgroundColor: "#F5F4FF", borderRadius: 12, padding: 10 },
  noteText: { color: "#59617B", fontSize: 14, lineHeight: 22 },
  subscribeButton: { marginTop: 16, height: 54, borderRadius: 16, borderWidth: 2, borderColor: "#111111", backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center" },
  subscribeText: { color: "#111111", fontSize: 18, fontWeight: "500" },
