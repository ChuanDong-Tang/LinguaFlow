...
const styles = StyleSheet.create({
  ...
  brandRow: { marginTop: 10, flexDirection: "row", alignItems: "center" },
  brand: { color: "#090909", fontSize: 24, fontWeight: "500" },
  debugButton: { marginLeft: "auto", width: 28, height: 28, borderRadius: 14, backgroundColor: "#F1F2F4", alignItems: "center", justifyContent: "center" },
  conversationRow: { marginTop: 44, minHeight: 74, flexDirection: "row", alignItems: "center" },
  avatarCircle: { width: 58, height: 58, borderRadius: 29, borderWidth: 1, borderColor: "#DCDDE4", alignItems: "center", justifyContent: "center" },
  avatarText: { fontSize: 15, color: "#33333a", letterSpacing: 1 },
  conversationBody: { flex: 1, marginLeft: 14, paddingRight: 12 },
  conversationTitle: { color: "#111111", fontSize: 18, fontWeight: "600" },
  conversationSubtitle: { marginTop: 4, color: "#7E8491", fontSize: 14, lineHeight: 20 },
  conversationMeta: { flexDirection: "row", alignItems: "center", gap: 10 },
  time: { color: "#8B8F97", fontSize: 13 },
  divider: { marginTop: 24, height: 1, backgroundColor: "#E5E7EB" },
  emptyArea: { flex: 1, alignItems: "center", justifyContent: "center", paddingBottom: 120 },
  emptyText: { marginTop: 20, color: "#8E93A0", fontSize: 16 },
  modalBackdrop: { flex: 1, backgroundColor: "rgba(17,17,17,0.38)", justifyContent: "center", paddingHorizontal: 20 },
  debugPanel: { borderRadius: 18, backgroundColor: "#FFFFFF", padding: 18 },
  debugTitle: { color: "#111111", fontSize: 20, fontWeight: "700", marginBottom: 10 },
  promptInput: { minHeight: 160, borderWidth: 1, borderColor: "#DFE3EA", borderRadius: 12, paddingHorizontal: 12, paddingVertical: 12, color: "#151922", fontSize: 14, backgroundColor: "#FAFBFC" },
  modelRow: { flexDirection: "row", gap: 8, marginTop: 12 },
  modelOption: { flex: 1, height: 40, borderRadius: 10, borderWidth: 1, borderColor: "#DFE3EA", alignItems: "center", justifyContent: "center", backgroundColor: "#FFFFFF" },
  modelOptionActive: { borderColor: "#111111", backgroundColor: "#111111" },
  modelText: { color: "#5D6470", fontSize: 13, fontWeight: "700" },
  modelTextActive: { color: "#FFFFFF" },
  saveButton: { marginTop: 12, height: 42, borderRadius: 12, backgroundColor: "#111111", alignItems: "center", justifyContent: "center" },
