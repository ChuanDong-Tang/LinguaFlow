...
export function PracticeScreen({ onOpenChat, onOpenMe, onOpenPracticeSession }: PracticeScreenProps) {
  ...
  const cards = useMemo(() => buildPracticeCards(messages), [messages]);
...
const styles = StyleSheet.create({
  ...
  title: { color: "#111111", fontSize: 24, fontWeight: "500", textAlign: "center", marginBottom: 28 },
  calendarPanel: { borderWidth: 1, borderColor: "#DDE1E8", borderRadius: 24, backgroundColor: "#FFFFFF", paddingHorizontal: 20, paddingTop: 20, paddingBottom: 20 },
  sectionTitle: { color: "#111111", fontSize: 24, fontWeight: "700" },
  monthRow: { marginTop: 22, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  arrowButton: { width: 44, height: 44, alignItems: "center", justifyContent: "center" },
  monthTitle: { color: "#111111", fontSize: 22, fontWeight: "700" },
  weekRow: { marginTop: 22, flexDirection: "row" },
  weekText: { width: "14.28%", textAlign: "center", color: "#686E7C", fontSize: 16 },
  grid: { marginTop: 12, flexDirection: "row", flexWrap: "wrap" },
  dayCell: { width: "14.28%", height: 47, alignItems: "center", justifyContent: "center" },
  dayBubble: { width: 40, height: 40, borderRadius: 14, alignItems: "center", justifyContent: "center" },
  dayBubbleLow: { backgroundColor: "#F2EFFF" },
  dayBubbleMid: { backgroundColor: "#DDD8FF" },
  dayBubbleHigh: { backgroundColor: "#9185FF" },
  dayText: { color: "#111111", fontSize: 18, fontWeight: "500" },
  dayTextMuted: { color: "#B7BCC7" },
  reviewRow: { marginTop: 14, flexDirection: "row", gap: 12 },
  reviewCard: { flex: 1, minHeight: 150, borderWidth: 1, borderColor: "#DDE1E8", borderRadius: 20, backgroundColor: "#FFFFFF", padding: 16 },
  reviewTitle: { color: "#111111", fontSize: 22, fontWeight: "700" },
  reviewSubtitle: { marginTop: 10, color: "#616777", fontSize: 15 },
  reviewBody: { marginTop: 18, color: "#616777", fontSize: 15, lineHeight: 21 },
  reviewFoot: { marginTop: "auto", flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  reviewIcon: { width: 42, height: 42, borderRadius: 21, backgroundColor: "#F0ECFF", alignItems: "center", justifyContent: "center" },
  quickCard: { marginTop: 16, minHeight: 94, borderWidth: 1, borderColor: "#DDE1E8", borderRadius: 20, backgroundColor: "#FFFFFF", paddingHorizontal: 18, flexDirection: "row", alignItems: "center" },
  quickIcon: { width: 56, height: 56, borderRadius: 28, backgroundColor: "#F0ECFF", alignItems: "center", justifyContent: "center" },
  quickBody: { flex: 1, marginLeft: 18 },
  quickTitle: { color: "#111111", fontSize: 23, fontWeight: "700" },
  quickSubtitle: { marginTop: 5, color: "#697080", fontSize: 15 },
  sheetBackdrop: { flex: 1, justifyContent: "flex-end" },
  sheetScrim: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(0,0,0,0.18)" },
  sheet: { backgroundColor: "#FFFFFF", borderTopLeftRadius: 26, borderTopRightRadius: 26, paddingHorizontal: 20, paddingBottom: 26 },
  sheetGrab: { alignSelf: "center", marginTop: 9, width: 56, height: 5, borderRadius: 999, backgroundColor: "#E1E3EA" },
  sheetTitle: { marginTop: 16, color: "#111111", fontSize: 22, fontWeight: "700", textAlign: "center" },
  pickerRow: { marginTop: 18, flexDirection: "row", gap: 10 },
  column: { flex: 1 },
  columnTitle: { color: "#5D6472", fontSize: 13, fontWeight: "700", textAlign: "center", marginBottom: 8 },
  columnScroll: { height: 190 },
  numberOption: { height: 42, borderRadius: 12, backgroundColor: "#F6F7FA", alignItems: "center", justifyContent: "center", marginBottom: 8 },
  bandOption: { minHeight: 42, borderRadius: 12, alignItems: "center", justifyContent: "center", marginBottom: 8, paddingHorizontal: 6 },
  optionSelected: { borderWidth: 2, borderColor: "#111111" },
  optionText: { color: "#111111", fontSize: 15, fontWeight: "700" },
  startButton: { marginTop: 20, height: 52, borderRadius: 18, backgroundColor: "#111111", alignItems: "center", justifyContent: "center" },
