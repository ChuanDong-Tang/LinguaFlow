...
RCT_EXPORT_VIEW_PROPERTY(answerRangesJson, NSString)
RCT_EXPORT_VIEW_PROPERTY(activeRangeJson, NSString)
RCT_EXPORT_VIEW_PROPERTY(answersVisible, BOOL)
RCT_EXPORT_VIEW_PROPERTY(visualsHidden, BOOL)
...
RCT_EXPORT_VIEW_PROPERTY(onSelectionEnd, RCTDirectEventBlock)
